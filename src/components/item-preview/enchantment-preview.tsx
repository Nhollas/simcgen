...
export function EnchantmentPreview({
  ...
  return (
    <div className="flex flex-row items-center gap-x-2 truncate">
      <div
        className="inline-flex h-6 w-6 flex-none items-center justify-center rounded-md bg-primary p-0.5 text-sm font-medium text-primary-foreground ring-offset-background transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
        style={{
